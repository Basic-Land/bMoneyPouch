...
public class Ref {
    ...
    public static Class<?> nms(String name, String pkg) {
        String path;
        if(version.startsWith("v1_18")) {
            path = "net.minecraft." + pkg + "." + name;
        } else {
            path = "net.minecraft.server." + version + "." + name;
        }
    ...
    public static Method method(Class<?> main, String oldName, String newName, Class<?>... bricks) {
        return method(main, version.startsWith("v1_18") ? newName : oldName, bricks);
    }
